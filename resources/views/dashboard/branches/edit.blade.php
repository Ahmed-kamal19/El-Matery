...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.branches.update', $branch->id) }}" class="form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.branches.index') }}">
                @csrf
                @method('PUT')
                <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">
                    <h3 class="fw-bolder text-dark">{{ __('Edit branch') . ' : ' . $branch->name }}</h3>
                </div>
                <!-- end   :: Card header -->
                ...
                <div class="inputs-wrapper">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_ar_inp" name="name_ar"
                                    value="{{ $branch['name_ar'] }}" placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_en_inp" name="name_en"
                                    value="{{ $branch['name_en'] }}" placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="address_ar_inp" name="address_ar"
                                    value="{{ $branch['address_ar'] }}" placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="address_en_inp" name="address_en"
                                    value="{{ $branch['address_en'] }}" placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="input-group mb-5 form-floatin">
                                ...
                                <input type="number" class="form-control" id="phone_inp" name="phone"
                                    value="{{ str_replace('966', '', $branch['phone']) }}" />
                            </div>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="input-group mb-5 form-floatin">
                                ...
                                <input type="number" class="form-control" id="whatsapp_inp" name="whatsapp"
                                    value="{{ str_replace('966', '', $branch['whatsapp']) }}" />
                            </div>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="frame_inp"
                                    value="{{ $branch['frame'] }}" name="frame" placeholder="example" />
                            ...
                            <select class="form-select" data-control="select2" name="city_id" id="city-sp"
                                ...
                                @foreach ($cities as $city)
                                    <option value="{{ $city['id'] }}"
                                        {{ $branch['city_id'] == $city->id ? 'selected' : '' }}> {{ $city['name'] }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-md-4 fv-row">
                            ...
                            <select class="form-select" data-control="select2" name="status" id="status-sp"
                                ...
                                data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                <option value="visible" {{ $branch['status'] == 'visible' ? 'selected' : '' }}>
                                    {{ __('visible') }}</option>
                                <option value="invisible" {{ $branch['status'] == 'invisible' ? 'selected' : '' }}>
                                    {{ __('invisible') }}</option>
                            </select>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-12 fv-row">
                            ...
                            <div class="text-center">
                                ...
                                <input type="hidden" id="lat_inp" name="lat" value="{{ $lat }}">
                                <input type="hidden" id="lng_inp" name="lng" value="{{ $lng }}">
