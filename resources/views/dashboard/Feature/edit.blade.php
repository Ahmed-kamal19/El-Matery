...
@section('content')
        ...
        <div class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-swapper="true" data-kt-swapper-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder fs-3 my-1"><a
                        href="{{ route('dashboard.feature.index') }}"
                        class="text-muted text-hover-primary">{{ __('feature') }}</a></h1>
                <!-- end   :: Title -->
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.feature.update',['feature'=>$feature->id]) }}" class="form" method="post" id="submitted-form"
                data-success-message="{{ __('feature updated successfully') }}"
                ...
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Edit a feature') }}</h3>
                    </div>
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" value="{{ $feature->title_ar }}" id="title_inp" name="title_ar"
                                    placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" value="{{ $feature->title_en}}" id="title_inp" name="title_en"
                                    placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" value="{{ $feature->icon }}" id="title_inp" name="icon"
                                    placeholder="example" />
