            ...
            <div class="card-body">
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('who Qitaf car section photo') }}</label>
                        <br>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-4">
                        <label class="form-label">{{ __('Why Qitaf icon card 1') }}</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <label class="form-label">{{ __('Why Qitaf icon card 2') }}</label>
                        <br>
                    ...
                    <div class="col-md-4">
                        ...
                        <label class="form-label">{{ __('Why Qitaf icon card 3') }}</label>
                        <br>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <!--    <label class="form-label">{{ __('Why Qitaf section card 3 in arabic') }}</label>-->
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf in arabic') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_cars_ar" data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_cars_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf in english') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_cars_en" data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_cars_en') ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf section card 1 in arabic') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_car_section_card_1_ar"
                            data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_car_section_card_1_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf section card 1 in english') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_car_section_card_1_en"
                            data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_car_section_card_1_en') ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf card 1 in arabic') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_car_section_card_1_ar"
                            data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_car_section_card_1_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf card 1 in english') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_car_section_card_1_en"
                            data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_car_section_card_1_en') ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf section card 2 in arabic') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_car_section_card_2_ar"
                            data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_car_section_card_2_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf section card 2 in english') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_car_section_card_2_en"
                            data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_car_section_card_2_en') ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf card 2 in arabic') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_cars_card_2_ar" data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_cars_card_2_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf card 2 in english') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_cars_card_2_en" data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_cars_card_2_en') ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf section card 3 in english') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_car_section_card_2_en"
                            data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_car_section_card_2_en') ?? '' !!}</textarea>
                ...
                <div class="fv-row row mb-15">
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf card 3 in arabic') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_cars_card_2_ar" data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_cars_card_2_ar') ?? '' !!}</textarea>
                    ...
                    <div class="col-md-6">
                        ...
                        <label class="form-label">{{ __('Why Qitaf card 3 in english') }}</label>
                        <textarea class="form-control form-control form-control" name="why_Qitaf_cars_card_2_en" data-kt-autosize="true">{!! settings()->getSettings('why_Qitaf_cars_card_2_en') ?? '' !!}</textarea>
