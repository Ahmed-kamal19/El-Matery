...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form   id="submitted-form"
                 >
                  <!-- begin :: Card header -->
                <div class="card-header d-flex align-items-center">

                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Features list') }}</h3>
                    </div>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" value="{{ $feature->title_ar }}" id="title_inp" name="title_ar"
                                    placeholder="example" />
                                <label for="title_inp">{{ __('Enter the feature title_ar ') }}</label>
                            </div>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" value="{{ $feature->title_en}}" id="title_inp" name="title_en"
                                    placeholder="example" />
                                <label for="title_inp">{{ __('Enter the feature title_en ') }}</label>
                            </div>
                            <p class="invalid-feedback" id="title"></p>
