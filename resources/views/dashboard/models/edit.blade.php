                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="meta_keyword_ar_inp" name="meta_keyword_ar"
                                    value="{{ $model->meta_keyword_ar }}" placeholder="{{ __('Enter the meta tag keywords in arabic') }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="meta_keyword_en_inp" name="meta_keyword_en"
                                    value="{{ $model->meta_keyword_en }}" placeholder="{{ __('Enter the meta tag keywords in english') }}" />
