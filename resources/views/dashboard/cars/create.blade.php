                            ...
                            <form class="form mt-0 mt-lg-10" id="submitted-form" enctype="multipart/form-data">
                                ...
                                <div class="p-8">
                                    ...
                                    <div class="row mb-10">
                                        ...
                                        <!-- end   :: Column -->
                                        {{--  <div class="col-md-4 fv-row">
                                            <label class="fs-5 fw-bold mb-2">{{ __('possibilities') }}</label>
                                            <select class="form-select" data-control="select2" name="possibilities[]"
                                                multiple id="possibilities-sp"
                                                data-placeholder="{{ __('Choose the possibilities') }}"
                                                data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                                @foreach ($possibilities as $possibility)
                                                    <option value="{{ $possibility['id'] }}">
                                                        {{ $possibility['title_' . getLocale()] }} </option>
                                                @endforeach

                                            </select>
                                            <p class="invalid-feedback" id="possibilities"></p>


                                        </div>
                                        <div class="col-md-4 fv-row">

                                            <label class="fs-5 fw-bold mb-2">{{ __('features') }}</label>
                                            <select class="form-select" multiple name="features[]" data-control="select2"
                                                data-placeholder="{{ __('Choose the feature') }}"
                                                data-dir="{{ isArabic() ? 'rtl' : 'ltr' }}">
                                                @foreach ($features as $feature)
                                                    <option value="{{ $feature['id'] }}">
                                                        {{ $feature['title_' . getLocale()] }} </option>
                                                @endforeach
