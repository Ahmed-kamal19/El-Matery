            ...
            <form action="{{ route('dashboard.possibility.update',['possibility'=>$possibility->id]) }}" class="form" method="post" id="submitted-form"
                ...
                <div class="card-header d-flex align-items-center">
                    ...
                    <div class="card-title">
                        <h3 class="fw-bolder text-dark">{{ __('Add new possibility') }}</h3>
                    </div>
                ...
                <div class="inputs-wrapper">
                    ...
                    <div class="row mb-8">
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-5 fw-bold mb-2">{{ __('Enter the possibility title_ar') }}</label>
                            <div class="form-floating">
                                <input type="text" class="form-control" value="{{ $possibility->title_ar }}" id="title_inp" name="title_ar"
                                    placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <label class="fs-5 fw-bold mb-2">{{ __('Enter the possibility title_en') }}</label>
                            <div class="form-floating">
                                <input type="text" class="form-control" value="{{ $possibility->title_en}}" id="title_inp" name="title_en"
                                    placeholder="example" />
