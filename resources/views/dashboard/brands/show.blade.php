            ...
            <div class="inputs-wrapper">
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" class="form-control" id="name_ar_inp" name="name_ar" value="{{ $brand->name_ar }}" readonly />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" class="form-control" id="name_en_inp" name="name_en" value="{{ $brand->name_en }}" readonly />
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" class="form-control" id="meta_keyword_ar_inp" name="meta_keyword_ar" value="{{ $brand->meta_keyword_ar }}" readonly />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" class="form-control" id="meta_keyword_en_inp" name="meta_keyword_en" value="{{ $brand->meta_keyword_en }}" readonly />
                ...
                <div class="row mb-10">
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" class="form-control" id="meta_desc_ar_inp" name="meta_desc_ar" value="{{ $brand->meta_desc_ar }}" readonly />
                    ...
                    <div class="col-md-6 fv-row">
                        ...
                        <input type="text" class="form-control" id="meta_desc_en_inp" name="meta_desc_en" value="{{ $brand->meta_desc_en }}" readonly />
