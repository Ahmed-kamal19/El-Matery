...
class StoreSettingRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            // 'image_about_us'=>['required_if:setting_type,website','nullable','mimes:jpeg,png,jpg,webp,svg','max:2048'],
            // 'cover_about_us'=>['required_if:setting_type,website','nullable','mimes:jpeg,png,jpg,webp,svg','max:2048'],
