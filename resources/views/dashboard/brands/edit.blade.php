...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-body p-0">
            <!-- begin :: Form -->
            <form action="{{ route('dashboard.brands.update', $brand->id) }}" class="form" method="post"
                id="submitted-form" data-redirection-url="{{ route('dashboard.brands.index') }}">
                @csrf
                @method('PUT')
                    ...
                    <div class="row mb-10">
                        ...
                        <div class="col-md-12 fv-row d-flex justify-content-evenly">
                            ...
                            <div class="d-flex flex-column align-items-center">
                                ...
                                <div>
                                    <x-dashboard.upload-image-inp name="cover" :image="$brand->cover" directory="Brands"
                                        placeholder="default.jpg" type="editable"></x-dashboard.upload-image-inp>
                                </div>
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_ar_inp" name="name_ar"
                                    value="{{ $brand->name_ar }}" placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="name_en_inp" name="name_en"
                                    value="{{ $brand->name_en }}" placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="meta_keyword_ar_inp" name="meta_keyword_ar"
                                    value="{{ $brand->meta_keyword_ar }}" placeholder="{{ __('Enter the meta tag keywords in arabic') }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="meta_keyword_en_inp" name="meta_keyword_en"
                                    value="{{ $brand->meta_keyword_en }}" placeholder="{{ __('Enter the meta tag keywords in english') }}" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="meta_desc_ar_inp" name="meta_desc_ar"
                                    value="{{ $brand->meta_desc_ar }}" placeholder="example" />
                        ...
                        <div class="col-md-6 fv-row">
                            ...
                            <div class="form-floating">
                                <input type="text" class="form-control" id="meta_desc_en_inp" name="meta_desc_en"
                                    value="{{ $brand->meta_desc_en }}" placeholder="example" />
                                <label
